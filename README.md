...
_Métricas atualizadas automaticamente em 2026-09-25 19:30._

- **166** itens em **18** categorias
- **166** fotos em `assets/fotos/` (completo)
- PDFs do site: Gastronomia `online/cardapio-prainha-rooftop-gastronomia.pdf` (6.81 MB) · Drinks `online/cardapio-prainha-rooftop-drinks.pdf` (3.14 MB)
- Versão dos dados: `1.1.63-online`
